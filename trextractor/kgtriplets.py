...
class KGTriplets():
    ...
    def get_prompt(self, text_chunk:str, static_prompt_fname:str='blackrock_prompt.txt'):

        with open(prompts_dir/static_prompt_fname, 'r') as file:
    ...
    def get_knowledge_graph_representation(self,
                                           text_chunk:str,
                                           static_prompt_fname:str='blackrock_prompt.txt',
                                           model:str="gpt-4o",
