...
o1 = "qual_evals/data/o1_knowledge_extraction.csv"
filenames = [mistral, gpt4o, gpt4omini, triplex, o1]
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        table5 = gr.DataFrame(headers=['subject', 'subject_type', 'relation', 'object', 'object_type'], label='o1')

    gr.Button("show chunk").click(
            fn=show,
            inputs=slider,
            outputs=[text, table1, table2, table3, table4, table5]
        )
    with gr.Row():
        btn = gr.Button("Flag")
